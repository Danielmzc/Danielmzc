<h1 align="center">Olá, eu sou Daniel Milanez Carvajal 👋</h1>
...
Desenvolvedor especializado em **automação financeira e sistemas quantitativos**.

Construí do zero e opero ao vivo um **bot de day trade algorítmico na B3** (mercado futuro WIN/WDO — Índice Bovespa e Dólar Futuro) com capital real, múltiplas estratégias simultâneas e gerenciamento de risco 100% automatizado.

Atuo também como **freelancer** em projetos de backend Python, automação de processos, APIs REST e análise de dados.
...
🤖 [Bot de Trading Algorítmico — B3 (WIN/WDO)](https://github.com/Danielmzc/daytrade-bot)
...
|---|---|---|
| ORB (Opening Range Breakout) | WIN | Rompimento da faixa de abertura com filtro KST e ADX |
| VWAP Reversion | WDO | Reversão ao VWAP com filtro de slope direcional |
| Momentum | Crypto | Momentum com regime de mercado (Bull/Bear/Sideways) |
| Liquidity Sweep | WIN/WDO | Captura de liquidez em extremos de range |
| Mean Reversion | Geral | Reversão à média com Bollinger Bands |
...
- 🐍 **Backend Python** — APIs REST, automação, scripts, integrações
- 🤖 **Bots e Automação** — bots de trading, bots Telegram/WhatsApp, scrapers, RPA
- 📊 **Dados e Análise** — pipelines de dados, backtesting, relatórios automáticos, BigQuery/dbt
- 🌐 **Deploy e Infra** — Docker, Railway, AWS, subdomínios, CI/CD simples

📬 **Plataformas:** Workana · 99Freelas · LinkedIn
...
- E-mail: danielmilanez07@gmail.com
